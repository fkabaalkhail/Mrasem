...
export default function NewActivityPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    const { error: insErr } = await sb.from("activities").insert({
      ...
      safety_guidelines: form.safety_guidelines || null,
      arabic_safety_guidelines: form.arabic_safety_guidelines || null,
    });
    setSaving(false);
    if (insErr) {
  ...
  return (
    <div>
      <div className="mb-6 flex items-center gap-4">
        ...
        <h1 className="text-2xl font-semibold text-mrasem-preiwinki">New activity</h1>
      </div>
      <form
