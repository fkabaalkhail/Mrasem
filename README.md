...
<p align="center">
  <a href="#"><img src="mrasem-admin-next/public/mrasem-logo-full.png" alt="Mrasem Logo" width="200" style="background-color: #1a1a1a; border-radius: 12px; padding: 16px;"/></a>
</p>
