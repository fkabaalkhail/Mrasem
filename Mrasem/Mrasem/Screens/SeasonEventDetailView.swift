        ...
        ZStack(alignment: .top) {
            ...
            VStack(spacing: 0) {
                ...
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    // About
                    Text(isArabic ? "عن الفعالية" : "About")
                    ...
                    Text(event.displayDescription(isArabic: isArabic))
                        .font(.custom("ExpoArabic-Medium", size: 12))
                        .fontWeight(.medium)
                    ...
                    NavigationLink(destination: BookingView(restaurant: nil, activity: nil, seasonEvent: event)) {
